...
<<<<<<< HEAD
          <a onclick="return confirm('from Another world. Are you sure you want to delete this entry??')" href="pro2delete.php?id=<?= $person->id ?>" class="btn btn-danger btn-sm">Delete</a>
=======
